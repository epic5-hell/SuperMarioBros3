...
#define MARIO_ANI_SMALL_MAX_SPEED_RIGHT		22
#define MARIO_ANI_SMALL_MAX_SPEED_LEFT		23
...
#define MARIO_ANI_RACCOON_MAX_SPEED_RIGHT	34
#define MARIO_ANI_RACCOON_MAX_SPEED_LEFT	35
